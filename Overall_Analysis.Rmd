...
es.t.test.raw <- rbind(es.t.test.raw, data.frame(t = summary(es)$coefficients[2,3],n1 = summary(es)$df[2],
                                                 n2 = summary(es)$df[2],
                                                 r = 0))
# note that r = 0 here because it is not a within subjects test
...
es.t.test.raw <- rbind(es.t.test.raw, data.frame(t = summary(es)$coefficients[2,3],n1 = summary(es)$df[2],
                                                 n2 = summary(es)$df[2],
                                                 r = 0))
 # Note that r = 0 here because this is not a within subjects test
...
es.t.test.raw <- rbind(es.t.test.raw, data.frame(t = summary(es)$coefficients[2,3],n1 = summary(es)$df[2],
                                                 n2 = summary(es)$df[2], r = 0))
# r = 0 because this is not a within subjects effect
...
es <- lm(rt~MeanAffectivity_column, data = sklar.emo.sum)
es.t.test.log <- rbind(es.t.test.log, data.frame(t = summary(es)$coefficients[2,3],n1 = summary(es)$df[2],n2 = summary(es)$df[2], r = 0))
...
es.t.test.raw <- rbind(es.t.test.raw, data.frame(t = summary(es)$coefficients[2,3],n1 = summary(es)$df[2],
                                                 n2 = summary(es)$df[2], r = 0))
# r = 0 because this is not a within subject effect
...
es.t.test.raw <- rbind(es.t.test.raw, data.frame(t = c(2.63,2.92,2.523,2.229,-4.48,-4.28), n1 = c(31,21,45,45,11,11), n2 = c(31,21,45,45,11,11), r = c(0.975,0.975,0,0,0.975,0.975)))
es.t.test.raw
...
summary(meta.ttestBF(t = raw.es$t,n1=raw.es$n.1,n2=raw.es$n.2,nullInterval = c(0,1)))
summary(meta.ttestBF(t = raw.es$t,n1=raw.es$n.1,n2=raw.es$n.2))
...
summary(meta.ttestBF(t = log.es$t,n1=log.es$n.1,n2=log.es$n.2,nullInterval = c(0,1)))
```
